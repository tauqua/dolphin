 ...
 *
 * TODO: Add combo implementation for mode...
 */

[configuration]

[OptionBool]
GUIName = UseBackgroundColor
OptionName = _UseBackgroundColor
DefaultValue = false

[OptionRGB]
GUIName = BackgroundColor
OptionName = _BackgroundColor
DefaultValue = 0.0, 0.0, 0.0
DependentOption = coloring

[OptionRGBA]
GUIName = OutlineColor
OptionName = _OutlineColor
DefaultValue = 0.0, 0.0, 0.0, 1.0

[OptionFloat]
GUIName = EdgeSlope
OptionName = _EdgeSlope
MinValue = 0.0
MaxValue = 10.0
StepAmount = 1.0
DefaultValue = 1.0
...
[OptionFloat]
GUIName = EdgeDetectionAccuracy
OptionName = _EdgeDetectionAccuracy
MinValue = 0.0
MaxValue = 100.0
StepAmount = 1.0
DefaultValue = 1.0
...
[OptionBool]
GUIName = EdgeDetectionDepth
OptionName = _EdgeDetectionDepth
DefaultValue = false
...
{
	if (OptionEnabled(_EdgeDetectionDepth))
	{
		float4 depth = float4(
