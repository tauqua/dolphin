...
// https://github.com/libretro/glsl-shaders/tree/master/reshade/shaders/LUT

[configuration]

[Meta]
Description = A shader that applies a color LUT (lookup-table)
Author = iwubcode / Fubaxiusz

[OptionFloat2]
GUIName = LutChromaLuma
OptionName = _LutChromaLuma
MinValue = 0.0, 0.0
MaxValue = 1.0, 1.0
StepAmount = 0.005
...
[OptionInt]
GUIName = LUT Block Size
OptionName = LUT_BLOCK_SIZE
MinValue = 16
MaxValue = 64
DefaultValue = 32
...
[OptionBool]
GUIName = LUT Vertical
OptionName = LUT_VERTICAL
DefaultValue = false
ResolveAtCompilation = True
