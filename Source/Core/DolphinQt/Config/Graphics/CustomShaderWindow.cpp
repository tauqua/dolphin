...
CustomShaderWindow::CustomShaderWindow(QWidget* parent)
    : QDialog(parent)
{
...
void CustomShaderWindow::CreateTabs()
{
  m_tab_widget = new QTabWidget;
  m_tab_widget->addTab(new PostProcessingShaderListWidget(
                     this, PostProcessingShaderListWidget::ShaderType::Textures),
                 tr("Textures"));
  m_tab_widget->addTab(
      new PostProcessingShaderListWidget(this, PostProcessingShaderListWidget::ShaderType::EFB),
      tr("EFB"));
  m_tab_widget->addTab(
      new PostProcessingShaderListWidget(this, PostProcessingShaderListWidget::ShaderType::XFB),
      tr("XFB"));
  m_tab_widget->addTab(
      new PostProcessingShaderListWidget(this, PostProcessingShaderListWidget::ShaderType::Post),
      tr("Post Process"));
}
...
void CustomShaderWindow::ConnectWidgets()
{
  ...
  connect(m_profiles_delete, &QPushButton::clicked, this, &CustomShaderWindow::OnDeleteProfilePressed);
...
void CustomShaderWindow::OnSaveProfilePressed()
{
  ...
  const std::string profile_path = File::GetUserPath(D_CONFIG_IDX) + PROFILES_DIR +
                                   CUSTOM_SHADERS_DIR + profile_name.toStdString() +
                                   ".ini";
